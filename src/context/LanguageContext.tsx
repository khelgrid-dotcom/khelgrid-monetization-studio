...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  ...
  hi: {
    ...
    sportsUpdatesTitle: "खेलवायर (KhelWire)",
  ...
  bn: {
    ...
    sportsUpdatesTitle: "খেলওয়্যার (KhelWire)",
  ...
  ta: {
    ...
    sportsUpdatesTitle: "கேல்வயர் (KhelWire)",
  ...
  te: {
    ...
    sportsUpdatesTitle: "ఖేల్వైర్ (KhelWire)",
  ...
  mr: {
    ...
    sportsUpdatesTitle: "खेळवायर (KhelWire)",
  ...
  gu: {
    ...
    sportsUpdatesTitle: "ખેલવાયર (KhelWire)",
  ...
  pa: {
    ...
    sportsUpdatesTitle: "ਖੇਲਵਾਇਰ (KhelWire)",
