...
function ScoutPortal() {
    ...
    <main className="mx-auto max-w-2xl px-4 py-12 sm:py-20">
      <div className="rounded-2xl border border-primary/30 bg-primary/5 p-6 text-center sm:p-10">
        ...
        <p className="mt-4 text-xs leading-relaxed text-muted-foreground">
          This prototype uses a demo role switch. Production access must be enforced by server-side
          authentication and recruiter permissions before real athlete data is connected.
        </p>
  ...
  return (
    <ProtectedRoute
      ...
      unauthorizedFallback={recruiterFallback}
      message="Please sign in with recruiter credentials to access the Scout Portal."
    >
            ...
            >
              ...
              <div className="mt-6 rounded-2xl border border-primary/30 bg-primary/5 p-4 sm:p-5">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  {saved && (
                    <span className="text-xs font-medium text-primary">Saved just now</span>
                  )}
                </div>
                <Textarea
                  value={draft}
