...
export const Route = createFileRoute("/start-from-zero")({
  head: () => ({ meta: [{ title: "Start From Zero · KhelGrid" }, { name: "description", content: "Begin your sports journey from absolute beginner with a guided 30-day plan." }, { name: "robots", content: "noindex,follow" }] }),
  component: () => (
    <ComingSoon
      icon={Sparkles}
      ...
      bullets={[
        "Choose a sport and understand the first practical steps",
